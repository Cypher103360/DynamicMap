...
class FineLocationPermissionTextProvider: PermissionTextProvider {
    override fun getDescription(isPermanentlyDeclined: Boolean): String {
        return if(isPermanentlyDeclined){
            "It seems you permanently declined Fine Location Permission. You can go to the app settings to grant it."
        } else {
            "This app needs access to your Fine Location to use map."
        }
    }
